...
@section('custom-title') Sem2 Result - {{$student->admissionNo}} @endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
			<div class="modal-header">
				<h5 class="mt-2">Sem2 - {{$student->admissionNo}}</h5>
			...
			<div class="modal-body card-body">
				<ul class="nav nav-tabs nav-tabs-sm">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#sem2Int">Internal</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#sem2Ext">External</a>
					</li>
				</ul>
				<div class="tab tab-content justify-content-center">
					<div class="tab-pane active mt-4" id="sem2Int">
						<h5 class="mb-4">Sem 2 Internal {{$student->branch}}</h5>
						<form method="post" class="form" action="{{action('Sem2\StudentAdminSem2Int@store', $student->id)}}">
							@csrf<div class="row">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-6 form-group">
											...
											<select name="int1" class="custom-select form-control">
												...
												<optgroup label="Common Year">
													<option value="Applied Chemistry - 2">Applied Chemistry - 2 (AC-2)</option>
													<option value="Applied Mathematics - 2">Applied Mathematics - 2 (AM-2)</option>
													<option value="Applied Physics - 2">Applied Physics - 2 (AP-2)</option>
													<option value="Communication Skills.">Communication Skills (CS)</option>
													<option value="Engg. Drawing">Enginnering Drawing (ED)</option>
													<option value="Structured Programming Approach">Structured Programming Approach (SPA)</option>
												</optgroup>
											</select>
											@error('int1')
					...
					<div class="tab-pane fade mt-4" id="sem2Ext">
						<h5 class="mb-4">Sem 2 External {{$student->branch}}</h5>
						<form method="post" class="form" action="{{action('Sem2\StudentAdminSem2Ext@store', $student->id)}}">
							@csrf<div class="row">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-6 form-group">
