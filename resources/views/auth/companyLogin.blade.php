...
@section('content')
<h4 class="mt-4 modal-header">Welcome to CMS (Company)
<div class="float-right">
	...
	<div class="dropdown-menu dropdown-menu">
		...
		<a class="dropdown-item" href="{{url('/staff/login')}}">Staff Login</a>
		<a class="dropdown-item" href="{{url('/student/login')}}">Student Login</a>
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" href="{{url('/company/new')}}">Company Register</a>
	</div>
	</div>
</div>
...
<div class="mt-5 container card-body bg-white col-md-6" style="box-shadow:0px 0px 8px rgba(0,0,0,0.1);border-radius:5px;">
	<form class="form container pt-3 pb-4" method="POST" action="{{ route('company.login.submit') }}">
