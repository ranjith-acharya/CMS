...
<div class="container">
	...
	@endif
	<div class="col-md-12">
		<h5 class="modal-header">Add New Staff</h5><br>
		<form class="form" method="post" enctype="multipart/form-data" action="{{action('StaffController@store')}}">
			@csrf<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-3 form-group">
					...
					<input type="text" name="subject" placeholder="Teaching subject" class="form-control" required>
				</div>
				<div class="col-md-3 form-group">
